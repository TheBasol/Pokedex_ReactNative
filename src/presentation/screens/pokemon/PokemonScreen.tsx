...
export const PokemonScreen = ({ navigation, route }: Props) => {
  ...
  return (
    <ScrollView
      ...
      <View style={ { marginTop: top + 10, marginRight: 20, position: 'absolute', right: 0, zIndex: 9999 } }>
        <Pressable onPress={ () => navigation.goBack() }>
          <Text variant="headlineSmall" style={{ color: 'white' }}> {"<"} Go Back</Text>
        </Pressable>
      </View>
      {/* Header Container */ }
      ...
      <FlatList
        ...
        showsHorizontalScrollIndicator={false}
        renderItem={({item}) => (
          <Chip style={ { marginLeft: 10, backgroundColor: 'rgba(0, 0, 0, 0.04)' } } selectedColor="white">{Formatter.capitalize(item)}</Chip>
        )}
      />
      ...
      <FlatList
        ...
        showsHorizontalScrollIndicator={false}
        renderItem={({item}) => (
          <View style={[styles.statsContainer, {padding: 5, borderRadius: 10, backgroundColor: 'rgba(0, 0, 0, 0.07)' }]}>
